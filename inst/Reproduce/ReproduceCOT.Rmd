...
# Case study
## The data
The data come from a study by Blum et al. looking at the effect of misoprostol vs. oxytocin at stopping post-partum hemorrhage. The data is described in the documents for the `pforOT` package which can be accessed by running
`?pforOT::pph`. A more detailed description is found in the paper *Optimal transport weights for causal inference*.
...
## Conclusions
This document reproduces the results for the paper *Optimal transport weights for causal inference* by Eric Dunipace. Any questions or concerns can be addressed by filing an issue at [https://github.com/ericdunipace/pforOT/issues](https://github.com/ericdunipace/pforOT/issues).
