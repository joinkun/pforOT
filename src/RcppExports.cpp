...
RcppExport SEXP _pforOT_bootStrap_(SEXP w_listSEXP, SEXP nbootSEXP, SEXP objectSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _pforOT_sbw_oop_bs_(SEXP w_listSEXP, SEXP nbootSEXP, SEXP sourceSEXP, SEXP targetSEXP, SEXP aSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::List& >::type w_list(w_listSEXP);
...
RcppExport SEXP _pforOT_entBW_obj_(SEXP vars_SEXP, SEXP A_SEXP, SEXP deltaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _pforOT_entBW_grad_(SEXP vars_SEXP, SEXP A_SEXP, SEXP deltaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const SEXP& >::type vars_(vars_SEXP);
...
RcppExport SEXP _pforOT_logSumExp(SEXP x_SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _pforOT_rowLogSumExp(SEXP x_SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _pforOT_colLogSumExp(SEXP x_SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< matrix& >::type x_(x_SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_pforOT_bootStrap_", (DL_FUNC) &_pforOT_bootStrap_, 3},
    {"_pforOT_sbw_oop_bs_", (DL_FUNC) &_pforOT_sbw_oop_bs_, 5},
    {"_pforOT_entBW_obj_", (DL_FUNC) &_pforOT_entBW_obj_, 3},
    {"_pforOT_entBW_grad_", (DL_FUNC) &_pforOT_entBW_grad_, 3},
    {"_pforOT_logSumExp", (DL_FUNC) &_pforOT_logSumExp, 1},
    {"_pforOT_rowLogSumExp", (DL_FUNC) &_pforOT_rowLogSumExp, 1},
    {"_pforOT_colLogSumExp", (DL_FUNC) &_pforOT_colLogSumExp, 1},
    {NULL, NULL, 0}
};

RcppExport void R_init_pforOT(DllInfo *dll) {
