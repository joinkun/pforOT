testthat::test_that("OT object forms tensor", {
  ...
  # giving masses
  testthat::expect_silent(ot1 <- pforOT:::OT$new(x = x, y = y, a = a, b = b, penalty = penalty, 
  cost = NULL, p = 2, debias = TRUE, tensorized = "auto",
  diameter=NULL))
  
  # no masses
  testthat::expect_silent(ot2 <- pforOT:::OT$new(x = x, y = y, penalty = penalty, 
                                       cost = NULL, p = 2, debias = TRUE, tensorized = "auto",
                                       diameter=NULL))
...
testthat::test_that("OT object forms online", {
  ...
  # giving masses
  pforOT:::rkeops_check()
  ot1 <- pforOT:::OT$new(x = x, y = y, a = a, b = b, penalty = penalty, 
...
testthat::test_that("sinkhorn_loop runs, tensor", {
  ...
  # compare
  # pot <- pforOT::sinkhorn(x = x*sqrt(0.5), y = y*sqrt(0.5), a = a, b = b, power = 2, blur = 10, scaling = 0.99, debias = FALSE )
...
testthat::test_that("sinkhorn_self runs, online", {
  ...
  # giving masses
  pforOT:::rkeops_check()
  ot <-pforOT:::OT$new(x = x, y = y, a = a, b = b, penalty = penalty, 
               cost = NULL, p = 2, debias = TRUE, tensorized = "online",
               diameter=NULL)
...
testthat::test_that("sinkhorn_dist runs, tensor", {
  ...
  testthat::expect_error( pforOT:::sinkhorn_dist(ot1))
  ot1$sinkhorn_opt(niter, tol)
  loss <- pforOT:::sinkhorn_dist(ot1)
...
testthat::test_that("sinkhorn_dist runs, online", {
  ...
  loss1 <- pforOT:::sinkhorn_dist(ot1)
...
testthat::test_that("OT infinite penalty distances online", {
  ...
  testthat::expect_silent(loss1 <- pforOT:::energy_dist(ot1))
  testthat::expect_silent(loss2 <- pforOT:::inf_sinkhorn_dist(ot1))
  testthat::expect_equal(loss1,loss2)
  
  pforOT:::rkeops_check()
  ot2 <- pforOT:::OT$new(x = x, y = y, a = a, b = b, penalty = penalty, 
                           cost = NULL, p = 2, debias = FALSE, tensorized = "online",
                           diameter=NULL)
  
  testthat::expect_silent(loss3 <- pforOT:::inf_sinkhorn_dist(ot2))
  ...
  loss <- pforOT:::inf_sinkhorn_dist(ot2)
